<x-jet-form-section submit="updateProfileInformation">
    <x-slot name="title">
        <h3 class="font-mont text-lg font-medium">Información de perfil</h3>
        {{-- {{ __('Profile Information') }} --}}
    </x-slot>

    <x-slot name="description">
        <p class="font-mont text-sm">Actualiza la información de tu perfil de usuario y correo electrónico</p>
