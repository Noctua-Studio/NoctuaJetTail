    ...
    <div class="logo__content bg-white tablet:bg-white items-center tablet:fixed tablet:top-0 tablet:justify-between tablet:w-full tablet:left-0 tablet:h-16 tablet:px-4 hidden tablet:flex">
