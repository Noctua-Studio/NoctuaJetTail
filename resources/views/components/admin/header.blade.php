    ...
    <div class="flex justify-between">
      ...
      @if ($buscar == 'true')
          <div class="h-full right-0 font-mont flex items-center tablet:absolute tablet:h-10 tablet:top-[70px] tablet:right-4 tablet:w-full tablet:left-4">
            ...
            <input wire:model="search" class="h-full rounded-md mr-[2px] outline-none border-none bg-gray-200 pl-12 text-lg text-gray-900 w-[250px] focus:w-[300px] laptop:focus:w-[250px] transition-all duration-150 tablet:w-[calc(100%-32px)] tablet:focus:w-[calc(100%-32px)] tablet:text-sm" type="text" id="search" placeholder="{{$buscarPlaceholder}}">
          </div>
      @endif
    </div>
